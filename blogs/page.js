...
export const metadata = {
  title: "Eagle IPTV Blog & Resources | EagleTVPanel",
  description:
    "Stay updated with Eagle IPTV — tutorials, IPTV news, reseller guides, and streaming insights.",
  keywords: [
    "Eagle IPTV blog",
    "IPTV tutorials",
    "IPTV reseller tips",
  ...
  openGraph: {
    title: "Eagle IPTV Blog & Resources | EagleTVPanel",
    description:
      "Explore IPTV insights, streaming tutorials, and reseller guides from Eagle IPTV.",
    url: "https://eagletvpanel.com/blogs",
    type: "website",
    images: [
      {
        url: "https://eagletvpanel.com/eagle-banner.jpg",
        width: 1200,
        height: 630,
        alt: "Eagle IPTV Blog",
      },
...
export default async function BlogPage() {
  ...
  const schema = {
    ...
    description:
      "Guides, updates, and detailed knowledge about IPTV streaming, reseller business, and Eagle IPTV updates.",
    url: "https://eagletvpanel.com/blogs",
    publisher: {
      "@type": "Organization",
      name: "Eagle IPTV",
    ...
    blogPost: blogPosts.map((post) => ({
      ...
      author: {
        "@type": "Person",
        name: post.author || "Eagle IPTV Team",
      },
      image: post.image,
    })),
  };
      ...
      <section className="min-h-[80vh] bg-[#0a0a0a] text-gray-200 px-6 py-16">
        <div className="max-w-5xl mx-auto text-center mb-16 mt-8">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Explore IPTV tutorials, industry insights, and reseller guidance — powered by Eagle IPTV.
          </p>
        </div>
